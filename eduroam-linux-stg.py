...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Technische Universität Dresden"
Config.profilename = "eduroam-sec"
Config.url = "https://tu-dresden.de"
Config.email = "servicedesk@tu-dresden.de"
Config.title = "eduroam CAT"
Config.server_match = "radius-eduroam.zih.tu-dresden.de"
...
Config.user_realm = "tu-dresden.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius-eduroam.zih.tu-dresden.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anon@tu-dresden.de"
